...
class BgcOverlapRenderingTests(unittest.TestCase):
    ...
    def test_shared_counts_are_not_double_counted_and_tool_specific_classes_are_union_relative_bars(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            pie_lines, _geometry = self.module.agreement_pie(300.0, 300.0, 100.0, 6.0, 6.0, 3.0)
            shared_label = next(line for line in pie_lines if "Shared (n = 6)" in line)
            self.assertIn('y="422.0"', shared_label)
